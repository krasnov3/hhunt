...
def check_shell():
    ...
    if "bash" not in shell:
        c.info_news("If you're having issues or not results, be sure to launch hhunt using bash for this operation.")
        c.info_news("OSX users should read this https://khast3x.club/posts/2021-02-17-hhunt-with-COMB/#targeting-emails\n")
